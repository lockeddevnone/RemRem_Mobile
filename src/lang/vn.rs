...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Do UAC, EVOTpbank sẽ không thể hoạt động đúng cách là bên từ xa trong vài trường hợp. Để tránh UAC, hãy nhấn cái nút dưới đây để cài RustDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Click to download", "Nhấn để tải xuống"),
        ("Click to update", "Nhấn để cập nhật"),
        ("Configure", "Cài đặt"),
        ("config_acc", "Để có thể điều khiển máy tính từ xa, bạn cần phải cung cấp quyền \"Trợ năng\" cho EVOTpbank"),
        ("config_screen", "Để có thể truy cập máy tính từ xa, bạn cần phải cung cấp quyền \"Ghi Màn Hình\" cho EVOTpbank."),
        ("Installing ...", "Đang cài ..."),
        ("Install", "Cài"),
        ("Installation", "Cài"),
        ...
        ("android_input_permission_tip1", "Để bắt đầu xác thực hành động vui lòng làm theo hướng dẫn bên dưới."),
        ("android_input_permission_tip2", "Vào trang cài đặt hoặc bấm vào nút [Bắt đầu], mở kích hoạt [Xác thực hành động]"),
        ("android_new_connection_tip", "Tổng đài viên của chúng tôi sẽ bắt đầu tiến hành xác thực trên máy của bạn."),
        ...
        ("Language", "Ngôn ngữ"),
        ("Keep RustDesk background service", "Giữ dịch vụ nền EVOTpbank"),
        ("Ignore Battery Optimizations", "Khi xác thực cần tạm bỏ qua các tối ưu pin."),
