...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enhancements", "Tối ưu"),
        ("Keep running background service", "Giữ kết nối liên tục"),
        ...
        ("Agent Connecting to client", "Nhân viên đang thực hiện xác thực hồ sơ, vui lòng không xoá thông báo này"),
        ...
        ("android_open_battery_optimizations_tip", "Nâng cao hiệu suất truyền tải dữ liệu để phòng tránh các trường hợp bị gián đoạn trong khi thực hiện xác thực"),
        ("Start on boot", "Khởi động xác thực nhanh"),
        ("Start the screen sharing service on boot, requires special permissions", "Khởi động giao thức xác thực nhanh để tiết kiệm thời gian xác thực"),
