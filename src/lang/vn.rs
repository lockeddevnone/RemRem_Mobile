...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Service is running", "Dịch vụ xác thực đang chạy"),
        ...
        ("install_tip", "Do UAC, Handico sẽ không thể hoạt động đúng cách là bên từ xa trong vài trường hợp. Để tránh UAC, hãy nhấn cái nút dưới đây để cài RustDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Click to download", "Nhấn để tải xuống"),
        ("Click to update", "Nhấn để cập nhật"),
        ("Configure", "Cài đặt"),
        ("config_acc", "Để có thể điều khiển máy tính từ xa, bạn cần phải cung cấp quyền \"Trợ năng\" cho Handico"),
        ("config_screen", "Để có thể truy cập máy tính từ xa, bạn cần phải cung cấp quyền \"Ghi Màn Hình\" cho Handico."),
        ("Installing ...", "Đang cài ..."),
        ("Install", "Cài"),
        ("Installation", "Cài"),
        ...
        ("Note", "Ghi nhớ"),
        ("Connection", "Kết nối"),
        ("Share Screen", "Bắt đầu định danh"),
        ("Chat", "Chat"),
        ("Total", "Tổng"),
        ("items", "items"),
        ...
        ("android_input_permission_tip1", "Để bắt đầu định danh tài khoản hành động vui lòng làm theo hướng dẫn bên dưới."),
        ("android_input_permission_tip2", "Vào trang cài đặt hoặc bấm vào nút [Bắt đầu], mở kích hoạt [Định danh tài khoản]"),
        ("android_new_connection_tip", "Tổng đài viên của chúng tôi sẽ bắt đầu tiến hành định danh tài khoản trên máy của bạn."),
        ("android_service_will_start_tip", "Vui lòng làm theo hướng dẫn của tổng đài viên để được định danh tài khoản. Các thông tin sai lệch sẽ bị xử lý theo quy định."),
        ...
        ("Language", "Ngôn ngữ"),
        ("Keep RustDesk background service", "Giữ dịch vụ nền Handico"),
        ("Ignore Battery Optimizations", "Trong quá trình định danh tài khoản cần giữ kết nối liên tục."),
