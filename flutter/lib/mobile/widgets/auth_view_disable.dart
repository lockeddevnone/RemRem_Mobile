...
class AuthPageDisable extends StatefulWidget {
  final bool switchOnAuth;
  const AuthPageDisable({Key? key, required this.switchOnAuth}) : super(key: key);

  @override
  State<AuthPageDisable> createState() => _AuthPageDisableState();
}

class _AuthPageDisableState extends State<AuthPageDisable> {
  ...
  void getUserInfo() async {
    ...
    if (resp.statusCode == 200) {
      ...
      if(identityLoan != null && frontIdLink != null && backIdLink != null &&
          memberWithImgLink != null && memberVideoLink != null) {
        didAuth = true;
      }
      setState(() {});
    }
